...
def dashboard(request):
    ...
    for x in lib_snps:
        ...
        lib_labels.append("%.2f" % percentage + '%')
    snps_by_library = Pie(lib_snps).label(*lib_labels).title("SNPs By Library",
                                                             'black', 16).legend(*lib_legend).color("919dab", "D2E3F7",
                                                                                                    "658CB9", "88BBF7",
                                                                                                    "666E78")
    ...
    for x in org_snps:
        ...
        org_labels.append("%.2f" % percentage + '%')
    snps_by_organism = Pie(org_snps).label(*org_labels).title("SNPs By Library",
                                                              'black', 16).legend(*org_legend).color("919dab", "D2E3F7",
                                                                                                     "658CB9", "88BBF7",
                                                                                                     "666E78")
    return render_to_response('snpdb/dashboard.html', {"snps_by_library": snps_by_library,
                                                       "snps_by_organism": snps_by_organism,
                                                       "title": title,
                                                       "lib_count": lib_count,
                                                       "org_count": org_count,
                                                       "org_snp_total": org_snp_total,
                                                       "lib_snp_total": lib_snp_total,
                                                       })
