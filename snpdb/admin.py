...
class SNPSummaryAdmin(admin.ModelAdmin):
    list_display = ('tag', 'value')
admin.site.register(SNP_Summary, SNPSummaryAdmin)


class SummaryLevelCVAdmin(admin.ModelAdmin):
    list_display = ('level_id', 'level_name')
    search_fields = ['level_id']
admin.site.register(Summary_Level_CV, SummaryLevelCVAdmin)
