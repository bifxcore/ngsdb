...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'snpdb_cnv', 'cnv_value', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'CNV.coverage'
        db.alter_column(u'snpdb_cnv', 'coverage', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))
    ...
    models = {
        ...
        u'snpdb.cnv': {
            ...
            'coverage': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
