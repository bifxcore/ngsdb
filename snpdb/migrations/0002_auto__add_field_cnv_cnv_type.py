...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CNV.cnv_type'
        db.add_column(u'snpdb_cnv', 'cnv_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['snpdb.CNV_CV']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CNV.cnv_type'
        db.delete_column(u'snpdb_cnv', 'cnv_type_id')
    ...
    models = {
        ...
        u'snpdb.cnv': {
            ...
            'cnv_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['snpdb.CNV_CV']"}),
