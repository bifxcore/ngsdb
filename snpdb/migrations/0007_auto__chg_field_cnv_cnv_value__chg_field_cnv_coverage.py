...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CNV.cnv_value'
        db.alter_column(u'snpdb_cnv', 'cnv_value', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

        # Changing field 'CNV.coverage'
        db.alter_column(u'snpdb_cnv', 'coverage', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

    def backwards(self, orm):

        # Changing field 'CNV.cnv_value'
        db.alter_column(u'snpdb_cnv', 'cnv_value', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CNV.coverage'
        db.alter_column(u'snpdb_cnv', 'coverage', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'snpdb.cnv': {
            ...
            'cnv_value': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '10'}),
            'coverage': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '10'}),
