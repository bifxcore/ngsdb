...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'CNV.window_size' to match new field type.
        db.rename_column(u'snpdb_cnv', 'window_size_id', 'window_size')
        # Changing field 'CNV.window_size'
        db.alter_column(u'snpdb_cnv', 'window_size', self.gf('django.db.models.fields.IntegerField')())
        # Removing index on 'CNV', fields ['window_size']
        db.delete_index(u'snpdb_cnv', ['window_size_id'])


    def backwards(self, orm):
        # Adding index on 'CNV', fields ['window_size']
        db.create_index(u'snpdb_cnv', ['window_size_id'])


        # Renaming column for 'CNV.window_size' to match new field type.
        db.rename_column(u'snpdb_cnv', 'window_size', 'window_size_id')
        # Changing field 'CNV.window_size'
        db.alter_column(u'snpdb_cnv', 'window_size_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['snpdb.CNV_CV']))
