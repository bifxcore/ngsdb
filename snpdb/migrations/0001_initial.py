...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'snpdb_effect', (
            ...
            ('effect_class', self.gf('django.db.models.fields.TextField')(db_index=True)),
            ('effect_string', self.gf('django.db.models.fields.TextField')(db_index=True)),
        ...
        db.create_table(u'snpdb_effect_cv', (
            ...
            ('effect_name', self.gf('django.db.models.fields.CharField')(max_length=45, db_index=True)),
        ))
        ...
        db.create_table(u'snpdb_filter_cv', (
            ...
            ('filter_type', self.gf('django.db.models.fields.TextField')(db_index=True)),
        ))
        ...
        db.create_table(u'snpdb_snp', (
            ...
            ('snp_position', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ngsdbview.ResultS', to=orm['ngsdbview.Result'])),
            ...
            ('library', self.gf('django.db.models.fields.related.ForeignKey')(related_name='samples.Library', to=orm['samples.Library'])),
        ...
        db.create_table(u'snpdb_snp_cv', (
            ...
            ('cv_value', self.gf('django.db.models.fields.TextField')(db_index=True)),
        ))
        ...
        db.create_table(u'snpdb_statistics_cv', (
            ...
            ('cvterm', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50, db_index=True)),
        ...
        db.create_table(u'snpdb_cnv', (
            ...
            ('cnv_value', self.gf('django.db.models.fields.FloatField')()),
            ('coverage', self.gf('django.db.models.fields.FloatField')()),
            ('library', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Library'])),
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngsdbview.Result'])),
            ('window_size', self.gf('django.db.models.fields.IntegerField')()),
        ))
    ...
    models = {
        ...
        u'samples.sample': {
            'Meta': {'ordering': "['sampleid']", 'object_name': 'Sample'},
            'author_modified': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            ...
            'samplename': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '20', 'db_index': 'True'}),
        ...
        u'snpdb.cnv': {
            ...
            'cnv_value': ('django.db.models.fields.FloatField', [], {}),
            ...
            'window_size': ('django.db.models.fields.IntegerField', [], {})
        },
        u'snpdb.cnv_cv': {
        ...
        u'snpdb.snp': {
            ...
            'library': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'samples.Library'", 'to': u"orm['samples.Library']"}),
            'quality': ('django.db.models.fields.IntegerField', [], {}),
            'ref_base': ('django.db.models.fields.TextField', [], {}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ngsdbview.ResultS'", 'to': u"orm['ngsdbview.Result']"}),
