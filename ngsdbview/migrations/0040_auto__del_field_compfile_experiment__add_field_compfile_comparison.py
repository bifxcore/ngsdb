...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Compfile.experiment'
        db.delete_column(u'ngsdbview_compfile', 'experiment_id')

        # Adding field 'Compfile.comparison'
        db.add_column(u'ngsdbview_compfile', 'comparison',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Comparison']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Compfile.experiment'
        raise RuntimeError("Cannot reverse this migration. 'Compfile.experiment' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Compfile.experiment'
        db.add_column(u'ngsdbview_compfile', 'experiment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngsdbview.Experiment']),
                      keep_default=False)

        # Deleting field 'Compfile.comparison'
        db.delete_column(u'ngsdbview_compfile', 'comparison_id')
    ...
    models = {
        ...
        u'ngsdbview.compfile': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'default': "'general'", 'max_length': '15', 'db_index': 'True'}),
