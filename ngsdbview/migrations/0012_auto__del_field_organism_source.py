...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organism.source'
        db.delete_column(u'ngsdbview_organism', 'source')


    def backwards(self, orm):
        # Adding field 'Organism.source'
        db.add_column(u'ngsdbview_organism', 'source',
                      self.gf('django.db.models.fields.CharField')(default='org.source.deprecated', max_length=100),
                      keep_default=False)
