...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compfile.filetype'
        db.add_column(u'ngsdbview_compfile', 'filetype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Exptfile.filetype'
        db.add_column(u'ngsdbview_exptfile', 'filetype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compfile.filetype'
        db.delete_column(u'ngsdbview_compfile', 'filetype')

        # Deleting field 'Exptfile.filetype'
        db.delete_column(u'ngsdbview_exptfile', 'filetype')
