...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comparison.compname'
        db.alter_column(u'ngsdbview_comparison', 'compname', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Comparison.compname'
        db.alter_column(u'ngsdbview_comparison', 'compname', self.gf('django.db.models.fields.CharField')(max_length=15))
