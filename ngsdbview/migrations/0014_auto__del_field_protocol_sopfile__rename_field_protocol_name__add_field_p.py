...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Protocol.sopfile'
        db.delete_column(u'ngsdbview_protocol', 'sopfile')

        # Renaming field 'Protocol.name'
        db.rename_column(u'ngsdbview_protocol', 'name', 'protocol_name')

        # Adding field 'Protocol.protocol_file'
        db.add_column(u'ngsdbview_protocol', 'protocol_file',
                      self.gf('django.db.models.fields.files.FileField')(default='unknown', max_length=100),
                      keep_default=False)

        # Adding field 'Protocol.protocol_link'
        db.add_column(u'ngsdbview_protocol', 'protocol_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Protocol.sopfile'
        db.add_column(u'ngsdbview_protocol', 'sopfile',
                      self.gf('django.db.models.fields.files.FileField')(default='renamed to protocol_name', max_length=100),
                      keep_default=False)

        # Renaming field 'Protocol.protocol_name'
        db.delete_column(u'ngsdbview_protocol', 'protocol_name', 'name')

        # Deleting field 'Protocol.protocol_file'
        db.delete_column(u'ngsdbview_protocol', 'protocol_file')

        # Deleting field 'Protocol.protocol_link'
        db.delete_column(u'ngsdbview_protocol', 'protocol_link')
