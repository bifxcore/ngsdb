...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organism.speceis'
        # db.delete_column(u'ngsdbview_organism', 'speceis')
	pass

        # Adding field 'Organism.species'
        # db.add_column(u'ngsdbview_organism', 'species',
        #              self.gf('django.db.models.fields.CharField')(default=2, max_length=45),
        #              keep_default=False)
	pass

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Organism.speceis'
        raise RuntimeError("Cannot reverse this migration. 'Organism.speceis' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Organism.speceis'
        db.add_column(u'ngsdbview_organism', 'speceis',
                      self.gf('django.db.models.fields.CharField')(max_length=45),
                      keep_default=False)

        # Deleting field 'Organism.species'
        db.delete_column(u'ngsdbview_organism', 'species')
