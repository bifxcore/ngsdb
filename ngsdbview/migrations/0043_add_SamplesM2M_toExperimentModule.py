...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field samples on 'Experiment'
        m2m_table_name = db.shorten_name(u'ngsdbview_experiment_samples')
        ...
        db.create_unique(m2m_table_name, ['experiment_id', 'sample_id'])


    def backwards(self, orm):
        # Removing M2M table for field samples on 'Experiment'
        db.delete_table(db.shorten_name(u'ngsdbview_experiment_samples'))
