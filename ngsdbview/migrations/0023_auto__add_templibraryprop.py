...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Templibraryprop'
        db.create_table(u'ngsdbview_templibraryprop', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('library_id', self.gf('django.db.models.fields.IntegerField')()),
            ('cvterm_id', self.gf('django.db.models.fields.IntegerField')()),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'ngsdbview', ['Templibraryprop'])


    def backwards(self, orm):
        # Deleting model 'Templibraryprop'
        db.delete_table(u'ngsdbview_templibraryprop')
