...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compfile.category'
        db.alter_column(u'ngsdbview_compfile', 'category', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Exptsetup.groupname'
        db.alter_column(u'ngsdbview_exptsetup', 'groupname', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Exptfile.category'
        db.alter_column(u'ngsdbview_exptfile', 'category', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'Compfile.category'
        db.alter_column(u'ngsdbview_compfile', 'category', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Exptsetup.groupname'
        db.alter_column(u'ngsdbview_exptsetup', 'groupname', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Exptfile.category'
        db.alter_column(u'ngsdbview_exptfile', 'category', self.gf('django.db.models.fields.CharField')(max_length=15))
