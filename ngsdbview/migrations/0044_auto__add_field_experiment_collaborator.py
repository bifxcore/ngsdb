...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.collaborator'
        db.add_column(u'ngsdbview_experiment', 'collaborator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['ngsdbview.Collaborator']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.collaborator'
        db.delete_column(u'ngsdbview_experiment', 'collaborator_id')
