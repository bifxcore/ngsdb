...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tagcount.library'
        db.add_column(u'ngsdbview_tagcount', 'library',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['samples.Library']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tagcount.library'
        db.delete_column(u'ngsdbview_tagcount', 'library_id')
