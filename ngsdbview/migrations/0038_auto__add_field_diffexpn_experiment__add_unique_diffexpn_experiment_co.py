...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Diffexpn.experiment'
        db.add_column(u'ngsdbview_diffexpn', 'experiment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Experiment']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Diffexpn.experiment'
        db.delete_column(u'ngsdbview_diffexpn', 'experiment_id')
