...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.result_type_cv_id'
        db.add_column(u'ngsdbview_result', 'result_type_cv_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Result.result_type_cv_id'
        db.delete_column(u'ngsdbview_result', 'result_type_cv_id_id')
    ...
    models = {
        ...
        u'ngsdbview.result': {
            ...
            'result_type_cv_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ngsdbview.Result_CV']"}),
            'time_data_loaded': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
