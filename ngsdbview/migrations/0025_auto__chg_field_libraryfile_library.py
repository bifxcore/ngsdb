...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Libraryfile.library'
        db.alter_column(u'ngsdbview_libraryfile', 'library_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Library']))

    def backwards(self, orm):

        # Changing field 'Libraryfile.library'
        db.alter_column(u'ngsdbview_libraryfile', 'library_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngsdbview.Library']))
