...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tempmtom.ngsdbview_libcode'
        db.add_column(u'ngsdbview_tempmtom', 'ngsdbview_libcode',
                      self.gf('django.db.models.fields.CharField')(default='old', max_length=10, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tempmtom.ngsdbview_libcode'
        db.delete_column(u'ngsdbview_tempmtom', 'ngsdbview_libcode')
