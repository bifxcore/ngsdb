...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.date_created'
        db.add_column(u'ngsdbview_experiment', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Experiment.date_modified'
        db.add_column(u'ngsdbview_experiment', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 6, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Experiment.author_modified'
        db.add_column(u'ngsdbview_experiment', 'author_modified',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.date_created'
        db.delete_column(u'ngsdbview_experiment', 'date_created')

        # Deleting field 'Experiment.date_modified'
        db.delete_column(u'ngsdbview_experiment', 'date_modified')

        # Deleting field 'Experiment.author_modified'
        db.delete_column(u'ngsdbview_experiment', 'author_modified_id')
