...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organism.isolate'
        db.delete_column(u'ngsdbview_organism', 'isolate')


    def backwards(self, orm):
        # Adding field 'Organism.isolate'
        db.add_column(u'ngsdbview_organism', 'isolate',
                      self.gf('django.db.models.fields.CharField')(default='isolate is deprecated', max_length=45),
                      keep_default=False)
