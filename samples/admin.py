...
class SampleAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Sample', {'fields':('sampleid', 'samplename', 'sampletype', 'collaborator', 'label_ontube', 'biosample')}),
    ...
    list_display = ('sampleid', 'samplename', 'sampletype', 'biosample', 'collaborator', 'organism', 'lifestage', 'genotype', 'growthphase', 'culture_method', 'treatment', 'time_after_treatment', 'sample_quantity', 'bioanalyzer_file_link', 'label_ontube', 'freezer_location')
    list_filter = ['sampletype', 'samplename', 'organism', 'lifestage', 'collaborator', 'treatment']
    search_fields = ['sampleid', 'samplename', 'biosample__biosample_code', 'sampletype', 'organism__organismcode', 'lifestage__lifestage', 'growthphase__growthphase', 'phenotype', 'genotype__genotype', 'collaborator__firstname', 'collaborator__lastname', 'source', 'collected_by', 'treatment', 'isolation_method', 'sample_quantity', 'biological_replicate_of', 'bioanalyzer_analysis', 'label_ontube', 'freezer_location', 'sample_notes']
    list_editable = ( 'samplename', 'growthphase', 'culture_method', 'lifestage', 'treatment', 'time_after_treatment')
