...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Library.biosample'
        db.delete_column(u'samples_library', 'biosample_id')


    def backwards(self, orm):
        # Adding field 'Library.biosample'
        db.add_column(u'samples_library', 'biosample',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['samples.Biosample']),
                      keep_default=False)
