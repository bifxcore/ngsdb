...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.collaborator'
        db.add_column(u'samples_sample', 'collaborator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='ngsdbview.collaboratorS', to=orm['ngsdbview.Collaborator']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.collaborator'
        db.delete_column(u'samples_sample', 'collaborator_id')
