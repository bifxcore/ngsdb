...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.time_after_treatment'
        db.add_column(u'samples_sample', 'time_after_treatment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.time_after_treatment'
        db.delete_column(u'samples_sample', 'time_after_treatment')
