...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.phenotypetwo'
        db.add_column(u'samples_sample', 'phenotypetwo',
                      self.gf('django.db.models.fields.CharField')(default='wildtype', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.phenotypetwo'
        db.delete_column(u'samples_sample', 'phenotypetwo')
