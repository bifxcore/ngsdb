...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Source'
        db.create_table(u'samples_source', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200, db_index=True)),
            ('notes', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'samples', ['Source'])

        # Adding model 'Sample'
        db.create_table(u'samples_sample', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sampleid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25, db_index=True)),
            ('sampletype', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('label_ontube', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=250, blank=True)),
            ('organism', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ngsdbview.organismS', to=orm['ngsdbview.Organism'])),
            ('lifestage', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ngsdbview.lifestageS', to=orm['ngsdbview.Lifestage'])),
            ('growthphase', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ngsdbview.growthphaseS', to=orm['ngsdbview.Growthphase'])),
            ('phenotype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ngsdbview.phenotypeS', to=orm['ngsdbview.Phenotype'])),
            ('genotype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ngsdbview.genotypeS', to=orm['ngsdbview.Genotype'])),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sourcename', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Source'])),
            ...
            ('collected_by_emailid', self.gf('django.db.models.fields.EmailField')(max_length=254, blank=True)),
            ('isolation_method', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('date_received', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('sample_concentration', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=4)),
            ('sample_volume', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('sample_quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=4)),
            ('parent_sampleid', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=25, blank=True)),
            ('sample_dilution', self.gf('django.db.models.fields.CharField')(default='NA', max_length=25, blank=True)),
            ('biological_replicate_of', self.gf('django.db.models.fields.CharField')(default='No Replicate', max_length=25, blank=True)),
            ('bioanalyzer_analysis', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('freezer_location', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        # Adding field 'Library.library_gelimage'
        db.add_column(u'samples_library', 'library_gelimage',
                      self.gf('django.db.models.fields.files.FileField')(default='NA', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Source'
        db.delete_table(u'samples_source')

        # Deleting model 'Sample'
        db.delete_table(u'samples_sample')

        # Deleting field 'Library.library_gelimage'
        db.delete_column(u'samples_library', 'library_gelimage')
    ...
    models = {
        ...
        u'samples.sample': {
            ...
            'freezer_location': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'sample_concentration': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '4'}),
            'sample_dilution': ('django.db.models.fields.CharField', [], {'default': "'NA'", 'max_length': '25', 'blank': 'True'}),
            'sample_notes': ('django.db.models.fields.TextField', [], {}),
            'sample_quantity': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '4'}),
            'sample_volume': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
