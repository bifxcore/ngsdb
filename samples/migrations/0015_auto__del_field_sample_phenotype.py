...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sample.phenotype'
        db.delete_column(u'samples_sample', 'phenotype_id')


    def backwards(self, orm):
        # Adding field 'Sample.phenotype'
        db.add_column(u'samples_sample', 'phenotype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='migrated into charfield', related_name='ngsdbview.phenotypeS', to=orm['ngsdbview.Phenotype']),
                      keep_default=False)
    ...
    models = {
        ...
        u'samples.sample': {
            ...
            'phenotypetwo': ('django.db.models.fields.CharField', [], {'default': "'wildtype'", 'max_length': '254'}),
