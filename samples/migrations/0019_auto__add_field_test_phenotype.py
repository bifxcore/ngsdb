...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Test.phenotype'
        db.add_column(u'samples_test', 'phenotype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='testphenotye', to=orm['ngsdbview.Phenotype']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Test.phenotype'
        db.delete_column(u'samples_test', 'phenotype_id')
