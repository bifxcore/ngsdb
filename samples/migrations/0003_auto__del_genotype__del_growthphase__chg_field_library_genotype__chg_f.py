...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Library.genotype'
        db.alter_column(u'samples_library', 'genotype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngsdbview.Genotype']))

        # Changing field 'Library.growthphase'
        db.alter_column(u'samples_library', 'growthphase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngsdbview.Growthphase']))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'samples_genotype', (
            ...
            ('genotype', self.gf('django.db.models.fields.CharField')(max_length=45, unique=True)),
        ...
        db.create_table(u'samples_growthphase', (
            ...
            ('growthphase', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        # Changing field 'Library.genotype'
        db.alter_column(u'samples_library', 'genotype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Genotype']))

        # Changing field 'Library.growthphase'
        db.alter_column(u'samples_library', 'growthphase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Growthphase']))
