...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Library.fastqfile_name'
        db.add_column(u'samples_library', 'fastqfile_name',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Library.fastqfile_readcount'
        db.add_column(u'samples_library', 'fastqfile_readcount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Library.fastqfile_md5sum'
        db.add_column(u'samples_library', 'fastqfile_md5sum',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Library.fastqfile_name'
        db.delete_column(u'samples_library', 'fastqfile_name')

        # Deleting field 'Library.fastqfile_readcount'
        db.delete_column(u'samples_library', 'fastqfile_readcount')

        # Deleting field 'Library.fastqfile_md5sum'
        db.delete_column(u'samples_library', 'fastqfile_md5sum')
