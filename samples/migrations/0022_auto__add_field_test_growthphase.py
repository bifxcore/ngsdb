...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Test.growthphase'
        db.add_column(u'samples_test', 'growthphase',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='test.growthphase', to=orm['ngsdbview.Growthphase']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Test.growthphase'
        db.delete_column(u'samples_test', 'growthphase_id')
    ...
    models = {
        ...
        u'samples.test': {
            ...
            'growthphase': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'test.growthphase'", 'to': u"orm['ngsdbview.Growthphase']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
