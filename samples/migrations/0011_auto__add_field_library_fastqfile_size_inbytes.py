...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Library.fastqfile_size_inbytes'
        db.add_column(u'samples_library', 'fastqfile_size_inbytes',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=50, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Library.fastqfile_size_inbytes'
        db.delete_column(u'samples_library', 'fastqfile_size_inbytes')
