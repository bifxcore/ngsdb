...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Biosample.collected_on_test'
        db.add_column(u'samples_biosample', 'collected_on_test',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 3, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Biosample.collected_on_test'
        db.delete_column(u'samples_biosample', 'collected_on_test')
