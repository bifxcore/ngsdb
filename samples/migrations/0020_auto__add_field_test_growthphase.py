...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'samples_test', 'growthphase',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='testgrowthphase', to=orm['ngsdbview.Growthphase']),
                      keep_default=False)
    ...
    models = {
        ...
        u'samples.test': {
            ...
            'growthphase': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'testgrowthphase'", 'to': u"orm['ngsdbview.Growthphase']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
