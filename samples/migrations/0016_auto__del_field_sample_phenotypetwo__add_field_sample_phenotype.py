...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Sample.phenotypetwo'
        db.rename_column(u'samples_sample', 'phenotypetwo', 'phenotype')



    def backwards(self, orm):
        # Renaming field 'Sample.phenotype'
        db.rename_column(u'samples_sample', 'phenotype', 'phenotypetwo')
