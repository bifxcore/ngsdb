...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Library.sampleid'
        db.add_column(u'samples_library', 'sampleid',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Sample'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Library.sampleid'
        db.delete_column(u'samples_library', 'sampleid_id')
