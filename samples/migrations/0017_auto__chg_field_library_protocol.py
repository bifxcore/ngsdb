...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'samples_library', 'protocol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngsdbview.Protocol']))

    def backwards(self, orm):

        # Changing field 'Library.protocol'
        db.alter_column(u'samples_library', 'protocol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Protocol']))
